...
//     // preprocess of image, reference to python code
...
int main(int argc, char **argv)
{
    ...
    for (int frame_index = 0; frame_index < total_frame_number; frame_index++)
    {
        ...
        {  
            ...
            //     sample_obj->skew_ratio = fqnet(sample_obj, rgb_img, raw_2d_objs, resnet18);
            //     ca::Profiler::tictoc("iou_prediction");
            ...
            if (whether_save_final_images && whether_save_final_cuboids_txt )
            {
                // save sample image
